...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        <div>
            <label class="form-label fw-semibold text-dark small mb-1">🖼️ Upload Gambar</label>
            <input type="file" 
                   name="foto" 
...
{{-- Harga Jual --}}
<div class="mb-3">
    <label class="form-label fw-semibold text-dark small mb-1">🏷️ Harga Jual <span class="text-danger">*</span></label>
    <input type="number" name="selling_price"
        class="form-control py-2 @error('selling_price') is-invalid @enderror rounded-3 shadow-sm"
        style="border-color: #f8bbd0;"
        value="{{ old('selling_price', $produk->harga_beli ?? '') }}">
    @error('selling_price')
        <div class="invalid-feedback mt-1 small text-danger">
            {{ $message }}
        </div>
