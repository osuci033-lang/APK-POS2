...
{{-- Tambahkan style margin-top negatif (mt-n3 / -1.5rem) agar naik menempel ke navbar --}}
            ...
            <div class="col-md-10">
                ...
                <div class="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4 text-white position-relative overflow-hidden" 
                    ...
                    <div class="position-relative z-1 text-center">
                        ...
                        <p class="lead opacity-85 mb-0 mx-auto" style="max-width: 650px;">
                ...
                <div class="card border-0 shadow-sm p-4 p-md-4 rounded-4 mb-4" style="background-color: rgba(255, 255, 255, 0.75); backdrop-filter: blur(5px);">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <span class="text-uppercase small fw-bold tracking-wider" style="color: #d81b60;">Definisi Kami</span>
                        ...
                        <div class="col-md-4 text-center mt-3 mt-md-0">
                            <div class="p-4 rounded-4 d-inline-block shadow-sm" style="background-color: rgba(255, 230, 235, 0.9); color: #d81b60;">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm p-4 rounded-4 h-100 border-top border-4 border-danger" style="background-color: rgba(255, 255, 255, 0.75); backdrop-filter: blur(5px);">
                            <div class="p-3 rounded-3 d-inline-block mb-3 shadow-sm" style="background-color: rgba(255, 230, 235, 0.9); color: #d81b60; width: fit-content;">
                                <i class="bi bi-eye-fill fs-3"></i>
                            </div>
                            <span class="text-uppercase small fw-bold" style="color: #d81b60;">Visi Utama</span>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm p-4 rounded-4 h-100 border-top border-4" style="background-color: rgba(255, 255, 255, 0.75); backdrop-filter: blur(5px); border-color: #ad1457 !important;">
                            <div class="p-3 rounded-3 d-inline-block mb-3 shadow-sm" style="background-color: rgba(255, 230, 235, 0.9); color: #d81b60; width: fit-content;">
                                <i class="bi bi-bullseye fs-3"></i>
                            </div>
                            <span class="text-uppercase small fw-bold" style="color: #d81b60;">Misi Kami</span>
                            <ul class="text-secondary ps-3 m-0 small" style="line-height: 1.8;">
                ...
                <div class="card border-0 shadow-sm p-4 rounded-4 mb-4" style="background-color: rgba(255, 255, 255, 0.75); backdrop-filter: blur(5px);">
                    <h5 class="fw-bold mb-3 text-center" style="color: #d81b60;">Prinsip Kerja Kami</h5>
                    <div class="row g-3 text-center">
                        <div class="col-md-4">
                            <div class="p-3 rounded-3 shadow-sm" style="background-color: rgba(255, 230, 235, 0.8);">
