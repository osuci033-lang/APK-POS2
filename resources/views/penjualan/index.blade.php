...
<div class="container-fluid py-4 px-3 px-md-4 bg-light min-vh-100">
    <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden" style="border: 1px solid #f8bbd0 !important;">
        <div class="p-4 text-white" style="background: linear-gradient(135deg, #ff758c 0%, #ff7eb3 100%);">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #fce4ec;">
                            ...
                            {{-- Nama Kasir --}}
                            <td>
                                <span class="badge fw-normal px-3 py-2 rounded-pill shadow-sm" style="background-color: #fff0f5; color: #880e4f; border: 1px solid #f8bbd0;">
                                     {{ $sale->user->name }}
                            ...
                            <td class="text-center">
                                @if(strtoupper($sale->metode_pembayaran) == 'CASH')
                                    <span class="badge rounded-pill px-3 py-2 fw-bold" style="background-color: #fce4ec; color: #d81b60; border: 1px solid #f8bbd0; font-size: 0.75rem;">
                                         CASH
                                    </span>
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-1">
                                    ...
                                    @if(strtoupper($sale->status) !== 'COMPLETED' && strtoupper($sale->status) !== 'SELESAI')
                                        <a href="{{ route('penjualan.edit', $sale) }}" 
                                           ...
                                           style="background: linear-gradient(135deg, #ffc107 0%, #ffca28 100%);">
                                            Edit
                                        </a>
                                        ...
                                        <form action="{{ route('penjualan.destroy', $sale) }}" 
                                            ...
                                            @method('DELETE')
                                            <button type="submit" 
                                                    class="btn btn-sm fw-semibold rounded-pill px-3 shadow-sm text-white border-0"
                                                    style="background: linear-gradient(135deg, #ff5252 0%, #ff1744 100%);">
                                               Hapus
                                            </button>
                                        </form>
                                        @endcan
