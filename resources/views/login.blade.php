...
{{-- Menimpa CSS Layout Utama agar 100% Full Screen tanpa Margin/Padding --}}
@push('styles')
<style>
    /* Hilangkan semua margin & padding bawaan body, html, dan main container */
    html, body {
    ...
    /* Memaksa wrapper utama layout app ikut hilang margin-nya */
...
<div class="d-flex align-items-center justify-content-center w-100 min-vh-100" 
     style="background: linear-gradient(135deg, #fce4ec 0%, #f8bbd0 40%, #e1f5fe 100%); margin: 0; padding: 20px 0; position: absolute; top: 0; left: 0; right: 0; bottom: 0;">
                        ...
                        <form action="{{ route('auth') }}" method="POST">
                            ...
                            <div class="mb-3 text-start">
                                <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                    <span class="input-group-text border-0 pe-0" style="background-color: #ffffff; color: #880e4f;">
                                    ...
                                    <input type="email" 
                                           name="email" 
                                           class="form-control form-control-lg border-0 ps-2 @error('email') is-invalid @enderror" 
                                           placeholder="Masukkan alamat email Anda" 
                                           value="{{ old('email') }}"
                                           style="font-size: 0.875rem; background-color: #ffffff; color: #880e4f;">
                                </div>
                            ...
                            <div class="mb-4 text-start">
                                <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                    ...
                                    <input type="password" 
                                           name="password" 
                                           class="form-control form-control-lg border-0 ps-2 @error('password') is-invalid @enderror" 
